...
class AmphibianListFragment : Fragment() {
    ...
    /*
    Dipanggil untuk memiliki fragmen instantiate tampilan antarmuka pengguna.
    Ini adalah opsional, dan fragmen non-grafis dapat kembali null.
    ...
    override fun onCreateView(
        ...
        binding.recyclerView.adapter = AmphibianListAdapter(AmphibianListener { amphibian ->
            ...
            /*
            Temukan NavController yang diberi fragmen yang memanggil ini pada fragmen yang bukan NavHostFragment atau dalam NavHostFragment akan menghasilkan IllegalStateException
             */
            findNavController()
